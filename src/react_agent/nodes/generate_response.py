...
from react_agent.prompts import agent_system_template
...
async def generate_response(
    ...
    # Render the Jinja template with state data and current date
    system_message = agent_system_template.render(
        state=state,
